...
OBJECTFILES = dft.o fft_it.o fft_rec.o fft_rec_cilk.o fft_rec_omp.o fft_it_omp.o prints.o num_gen.o numgenparser.o fft_rec_mpi.o
EXECS = dft fft_it fft_rec num_gen fft_rec_cilk fft_rec_omp fft_rec_mpi fft_it_omp fft_rec omp
.PHONY: all clean

all: dft fft_it fft_rec num_gen fft_rec_cilk fft_rec_mpi fft_rec_omp fft_it_omp
